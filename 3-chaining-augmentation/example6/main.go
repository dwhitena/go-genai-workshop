...
func run(query, queryContext string, messages []client.ChatMessage) (float64, string, error) {
	...
	err := cln.ChatSSE(ctx, client.Models.Hermes2ProMistral7B, messages, 1000, 0.1, ch)
	if err != nil {
